...
const Alert = React.forwardRef<HTMLDivElement, AlertProps>(
  ({ className, variant = 'info', title, children, onClose, ...props }, ref) => {
    const alertClasses = cn(
      ...
      {
        'bg-blue-50 border-blue-400 text-blue-800': variant === 'info',
        'bg-green-50 border-green-400 text-green-800': variant === 'success',
        'bg-yellow-50 border-yellow-400 text-yellow-800': variant === 'warning',
        'bg-red-50 border-red-400 text-red-800': variant === 'error',
      },
      className
    );
