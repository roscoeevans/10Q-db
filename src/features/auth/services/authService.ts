...
import { permissionService, type PermissionCheck } from '../../../lib/permissions';
import type { AuthState, AuthService as IAuthService } from '../types';
...
export class AuthService implements IAuthService {
  ...
  private async checkUserPermission(user: User): Promise<void> {
    try {
      this.authState = { ...this.authState, permissionLoading: true };
      this.notifyListeners();
